...
class CliArgProfileTests(TestCase):
    ...
    def test_revanced_v6_profile_does_not_emit_morphe_only_flag(self: Self) -> None:
        """ReVanced docs do not list the Morphe flag, so the v6 profile should avoid unknown CLI args."""
        _, patch_args = merge_cli_arg_maps("revanced-cli-v6", ("", ""))
